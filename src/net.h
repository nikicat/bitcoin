...
private:
    ...
    bool BindListenPort(const CService& bindAddr, bilingual_str& strError, NetPermissionFlags permissions, const std::string& service);
    bool Bind(const CService& addr, unsigned int flags, NetPermissionFlags permissions, const std::string& service);
